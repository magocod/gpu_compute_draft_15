...
pub const HIP_SUCCESS: _bindgen_ty_2 = 0;
pub const HIP_ERROR_INVALID_VALUE: _bindgen_ty_2 = 1;
pub const HIP_ERROR_NOT_INITIALIZED: _bindgen_ty_2 = 2;
pub const HIP_ERROR_LAUNCH_OUT_OF_RESOURCES: _bindgen_ty_2 = 3;
